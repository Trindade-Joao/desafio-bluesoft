...
import br.com.bluesoft.desafiov3.desafiov3.pedido.model.exception.PedidoUltrapassaLimiteException;
...
public class PedidoService {
    ...
    public Pedido novoPedido(PedidoFormulario pedidoFormulario) throws EstoqueVazioException , PedidoUltrapassaLimiteException {
        ...
        if(pedidoFormulario.getItens().size() < 50 ){
            for (ItemPedidoFormulario item : pedidoFormulario.getItens()) {
                ...
                throw new PedidoUltrapassaLimiteException();
            }
